...
object CelestialSphereBuilder {

    /**
     * Builds an inverted background celestial sphere representing deep space and the Milky Way.
     */
    fun buildMilkyWaySphere(
        engine: Engine,
        radius: Float = 125.0f,
        latSegments: Int = 48,
        lonSegments: Int = 96
        ...
        // Inside-facing triangles for background sphere
    ...
    /**
     * Builds a billboard quad for the Sun with custom UVs.
     */
    fun buildSunBillboard(
        engine: Engine,
        halfSize: Float = 8.5f
    ): EarthMesh {
        val numVertices = 4
        ...
        // 4 vertices of a quad in XY plane
        posBuffer.put(-halfSize).put(-halfSize).put(0f)
        posBuffer.put( halfSize).put(-halfSize).put(0f)
        posBuffer.put( halfSize).put( halfSize).put(0f)
        posBuffer.put(-halfSize).put( halfSize).put(0f)
        ...
        // 2 triangles
        indexBufferData.put(0)
        indexBufferData.put(1)
        indexBufferData.put(2)

        indexBufferData.put(0)
        indexBufferData.put(2)
        indexBufferData.put(3)
